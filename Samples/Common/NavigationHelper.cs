...
namespace WpToWinrt.Common
{
    ...
    {
        /// <summary>
        /// This isn't in the original control, 
        /// It's used to supress Go back command in windows phone if needed.
        /// 
        /// </summary>
        public bool SuppressBack { get; set; }
        ...
        {
            return this.Frame != null && this.Frame.CanGoBack && !SuppressBack;
        }
        /// <summary>
